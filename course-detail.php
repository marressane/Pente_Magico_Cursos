     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           ...
           <ol class="breadcrumb">
            <li><a href="#">Home</a></li>            
            <li class="active">Cursos - Detalhes</li>
          </ol>
         </div>
       </div>
     </div>
                    ...
                    <div class="col-md-12">
                      <div class="mu-latest-course-single">
                        <figure class="mu-latest-course-img">
                          <a href="#"><img src="assets/img/gallery/big/4.jpg" alt="img"></a>
                        ...
                        <div class="mu-latest-course-single-content">
                          <h2><a href="#">Maquilhagem</a></h2>
                          <h4>Informação do Curso</h4>
                          <ul>
                            <li> <span>Preço</span> <span>  MZN 10.000</span></li>
                            <li> <span>Lugar</span> <span>  Bairro Central Nr 1054, Maputo-MZ</span></li>
                            <li> <span>Total de alunos Por Turma</span> <span>  10+</span></li>
                            <li> <span>Duração do curso</span> <span>  4 Semanas</span></li>
                            <li> <span>Data de Inicio</span> <span> 10 de Agosto 2021</span></li>
                          </ul>
                          ...
                          <p>Neste curso, voce ira aprender tecnicas para fazer penteados, desde os casuais ate aos cerimoniais com destaque para Noivas.Neste curso, voce ira aprender tecnicas para fazer penteados, desde os casuais ate aos cerimoniais com destaque para Noivas.</p>
                          <blockquote>
                            <p>Neste curso, voce ira aprender tecnicas para fazer penteados, desde os casuais ate aos cerimoniais com destaque para Noivas.b.</p>
                          </blockquote>
                          <p>Neste curso, voce ira aprender tecnicas para fazer penteados, desde os casuais ate aos cerimoniais com destaque para Noivas.Neste curso, voce ira aprender tecnicas para fazer penteados, desde os casuais ate aos cerimoniais com destaque para Noivas..</p>
                    ...
                    <div id="mu-related-item-slide">
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          ...
                          <div class="mu-latest-course-single-content">
                            <h4><a href="#">Penteados para noivas.</a></h4>
                            <p>Neste curso, voce ira aprender tecnicas para fazer penteados, desde os casuais ate aos cerimoniais com destaque para Noivas.</p>
                      ...
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          ...
                          <div class="mu-latest-course-single-content">
                            <h4><a href="#">Manicure & Pedicure</a></h4>
                            <p>Neste curso, voce ira aprender tecnicas para fazer penteados, desde os casuais ate aos cerimoniais com destaque para Noivas.</p>
                            <div class="mu-latest-course-single-contbottom">
                              <a href="#" class="mu-course-details">Detalhes</a>
                              <span href="#" class="mu-course-price">MZN 10.000</span>
